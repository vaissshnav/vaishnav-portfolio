...
import { a as ArrowUpRight, i as ChevronDown, n as Moon, r as Download, t as Sun } from "../_libs/lucide-react.mjs";
import { n as Root2, r as Trigger, t as Content2 } from "../_libs/@radix-ui/react-hover-card+[...].mjs";
import { t as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BO3IhJq1.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var STORAGE_KEY = "vaishnav-theme";
...
function ThemeToggle() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		...
		children: theme === "dark" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sun, { className: "h-4 w-4 transition-colors group-hover:text-accent" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Moon, { className: "h-4 w-4 transition-colors group-hover:text-accent" })
	});
}
var SECTIONS = [
	{
...
var NODES = [
	...
	},
	{
		...
		summary: "Amidst the AI boom, when everyone focused on the applications, I was stuck think about what made it possiblem, the compute, the hardware. and my curiosity led me to EEE at MIT M.",
		logo: "LIFE",
		tags: [
			"Books",
			"Hardware",
...
function JourneyCard({ node, isActive }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("article", {
		className: "group relative block rounded-lg border bg-card p-6 text-left transition-all duration-300 hover:-translate-y-0.5",
...
function Divider() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "mx-auto my-32 max-w-5xl px-6",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function SectionHeader({ index, title }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "mx-auto mb-16 flex max-w-5xl items-baseline gap-6 px-6",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "mono-label",
			children: index
...
function About() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-12 max-w-2xl space-y-8 text-lg leading-[1.75] text-foreground/85 sm:text-xl",
				children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mono-label mt-24 flex items-center gap-3 text-muted-foreground",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function Interests() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeader, {
			...
			className: "mx-auto grid max-w-5xl gap-12 px-6 md:grid-cols-[1fr_0.9fr] md:items-start",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					className: "mono-label space-y-2 pt-2",
					children: [
...
function Reading() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "mx-auto mb-12 max-w-2xl px-6 text-sm leading-[1.75] text-muted-foreground",
				children: [
