...
//#region node_modules/.nitro/vite/services/ssr/assets/router-VfW1hjZO.js
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-UMc-TlyZ.css";
...
var Route$1 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A living map of how I think and what I'm building."
			},
			{
				property: "og:title",
				content: "Vaishnav"
...
function RootShell({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("head", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("script", { dangerouslySetInnerHTML: { __html: `
              (function() {
                try {
                  var theme = localStorage.getItem('vaishnav-theme');
...
var $$splitComponentImporter = () => import("./routes-BO3IhJq1.mjs");
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({ meta: [
		{ title: "Vaishnav - A map of how the thinking evolved" },
		{
			name: "description",
			content: "A living map of how Vaishnav thinks; community, design, product, startups, and the turn toward hardware, semiconductors and AI infrastructure."
		},
		{
			property: "og:title",
			content: "Vaishnav"
